...
public class tk2dTileMapEditor : Editor, ITileMapEditorHost
{
	...
	void DrawSettingsPanel()
	{
		...
		if (Foldout(ref editorData.setupMode, tk2dTileMapEditorData.SetupMode.TileProperties, "Tile Properties"))
		{
			...
			if (spriteDef != null) {
				spritePixelOrigin = new Vector2(spriteDef.untrimmedBoundsDataCenter.x / spriteDef.texelSize.x, spriteDef.untrimmedBoundsDataCenter.y / spriteDef.texelSize.y);
				spritePixelSize = new Vector2(spriteDef.untrimmedBoundsDataExtents.x / spriteDef.texelSize.x, spriteDef.untrimmedBoundsDataExtents.y / spriteDef.texelSize.y);
			}
	...
	void Init(tk2dTileMapData tileMapData)
	{
		if (tileMap.SpriteCollectionInst != null) {
			tileMapData.tileSize = tileMap.SpriteCollectionInst.spriteDefinitions[0].untrimmedBoundsDataExtents;
			tileMapData.tileOrigin = this.tileMap.SpriteCollectionInst.spriteDefinitions[0].untrimmedBoundsDataCenter - tileMap.SpriteCollectionInst.spriteDefinitions[0].untrimmedBoundsDataExtents * 0.5f;
		}
	}
