...
public class tk2dSlicedSprite : tk2dBaseSprite
{
	...
	void PermanentUpgradeLegacyMode() {
		...
		// Guess anchor
		float x = def.untrimmedBoundsDataCenter.x;
		float y = def.untrimmedBoundsDataCenter.y;
		float w = def.untrimmedBoundsDataExtents.x;
		float h = def.untrimmedBoundsDataExtents.y;
