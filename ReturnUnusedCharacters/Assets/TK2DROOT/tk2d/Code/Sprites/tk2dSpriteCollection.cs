...
public class tk2dSpriteCollectionDefault
{
    public bool additive = false;
    public Vector3 scale = new Vector3(1,1,1);
	public tk2dSpriteCollectionDefinition.Anchor anchor = tk2dSpriteCollectionDefinition.Anchor.LowerLeft;
	public tk2dSpriteCollectionDefinition.Pad pad = tk2dSpriteCollectionDefinition.Pad.BlackZeroAlpha;	
	
	public tk2dSpriteCollectionDefinition.ColliderType colliderType = tk2dSpriteCollectionDefinition.ColliderType.Polygon;
}
...
public class tk2dSpriteCollection : MonoBehaviour 
{
	...
	public tk2dSpriteCollectionFont[] fonts = new tk2dSpriteCollectionFont[0];
    ...
    public tk2dSpriteCollectionDefinition[] textureParams = new tk2dSpriteCollectionDefinition[0];
