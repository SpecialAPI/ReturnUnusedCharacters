...
public abstract class tk2dBaseSprite : MonoBehaviour, tk2dRuntime.ISpriteCollectionForceBuild
{
	...
	public Bounds GetBounds()
	{
		...
		return new Bounds(new Vector3(sprite.boundsDataCenter.x * _scale.x, sprite.boundsDataCenter.y * _scale.y, sprite.boundsDataCenter.z * _scale.z),
		                  new Vector3(sprite.boundsDataExtents.x * Mathf.Abs(_scale.x), sprite.boundsDataExtents.y * Mathf.Abs(_scale.y), sprite.boundsDataExtents.z * Mathf.Abs(_scale.z) ));
	}
	...
	public Bounds GetUntrimmedBounds()
	{
		InitInstance();
		var sprite = collectionInst.spriteDefinitions[_spriteId];
		return new Bounds(new Vector3(sprite.untrimmedBoundsDataCenter.x * _scale.x, sprite.untrimmedBoundsDataCenter.y * _scale.y, sprite.untrimmedBoundsDataCenter.z * _scale.z),
		                  new Vector3(sprite.untrimmedBoundsDataExtents.x * Mathf.Abs(_scale.x), sprite.untrimmedBoundsDataExtents.y * Mathf.Abs(_scale.y), sprite.untrimmedBoundsDataExtents.z * Mathf.Abs(_scale.z) ));
	}
